...
SOURCEFILES_QUOTED_IF_SPACED=Intro-1-Input-Output.c PIC16F1459-config.c UBMP410.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Intro-1-Input-Output.p1 ${OBJECTDIR}/PIC16F1459-config.p1 ${OBJECTDIR}/UBMP410.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Intro-1-Input-Output.p1.d ${OBJECTDIR}/PIC16F1459-config.p1.d ${OBJECTDIR}/UBMP410.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Intro-1-Input-Output.p1 ${OBJECTDIR}/PIC16F1459-config.p1 ${OBJECTDIR}/UBMP410.p1

# Source Files
SOURCEFILES=Intro-1-Input-Output.c PIC16F1459-config.c UBMP410.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Intro-1-Input-Output.p1: Intro-1-Input-Output.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Intro-1-Input-Output.p1.d 
	@${RM} ${OBJECTDIR}/Intro-1-Input-Output.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -mrom=default,-0-7FF -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=800  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/Intro-1-Input-Output.p1 Intro-1-Input-Output.c 
	@-${MV} ${OBJECTDIR}/Intro-1-Input-Output.d ${OBJECTDIR}/Intro-1-Input-Output.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Intro-1-Input-Output.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
